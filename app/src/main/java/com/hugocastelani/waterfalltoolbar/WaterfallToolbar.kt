...
open class WaterfallToolbar : CardView {
    ...
    private fun init(context: Context?, attrs: AttributeSet?) {
        ...
        if (context != null && attrs != null) {
            val typedArray = context.obtainStyledAttributes(attrs, _styleable.WaterfallToolbar)

            val rawInitialElevation = typedArray.getDimensionPixelSize(
                    _styleable.WaterfallToolbar_initial_elevation, defaultInitialElevation.value)

            val rawFinalElevation = typedArray.getDimensionPixelSize(
                    _styleable.WaterfallToolbar_final_elevation, defaultFinalElevation.value)

            scrollFinalPosition = typedArray.getInteger(
                    _styleable.WaterfallToolbar_scroll_final_elevation, defaultScrollFinalElevation)
    ...
    private class SavedState : View.BaseSavedState {
        ...
        companion object {
            @JvmField internal val CREATOR: Parcelable.Creator<SavedState> = object : Parcelable.Creator<SavedState> {

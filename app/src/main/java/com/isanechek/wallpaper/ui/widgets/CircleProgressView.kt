...
import com.isanechek.wallpaper.utils.AnimationUtils
...
private const val END_VALUE = 280F
private const val START_VALUE = 15F
...
class CircleProgressView(context: Context, attrs: AttributeSet) : View(context, attrs), Animatable {
    ...
    var backgroundCircleColor = Color.parseColor("#ffffff")
        set(value) {
            field = value
